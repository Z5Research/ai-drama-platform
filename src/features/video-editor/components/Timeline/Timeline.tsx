  ...
  return (
    <div className="timeline" style={{
      ...
      <div style={{
        ...
        <span style={{ fontSize: '12px', color: 'var(--glass-text-secondary, #999)' }}>缩放</span>
        <input
          type="range"
          min="0.5"
          max="3"
          ...
          style={{ width: '100px' }}
        />
        <span style={{ fontSize: '12px', color: 'var(--glass-text-tertiary, #666)' }}>
      ...
      >
        ...
        <div style={{
          ...
          background: 'linear-gradient(90deg, var(--glass-accent-from, #4F46E5) 0%, var(--glass-accent-to, #7C3AED) 100%)',
        ...
        <div style={{
          ...
          bottom: '-4px',
          width: '3px',
          background: 'var(--glass-accent-to, #7C3AED)',
          borderRadius: '2px',
...
const SortableClip: React.FC<SortableClipProps> = ({
  ...
  const style: React.CSSProperties = {
    ...
    background: isSelected
      ? 'var(--glass-accent-from, #4F46E5)'
      : isDragging
        ? 'var(--glass-bg-muted, #2a2a2a)'
        : 'var(--glass-bg-surface, #1e1e1e)',
    borderRadius: '4px',
    display: 'flex',
    alignItems: 'center',
    justifyContent: 'center',
    fontSize: '11px',
    color: isSelected ? 'white' : 'var(--glass-text-primary, #fff)',
    cursor: isDragging ? 'grabbing' : 'grab',
    flexShrink: 0,
    border: isSelected ? '2px solid var(--glass-stroke-focus, #7C3AED)' : '1px solid var(--glass-stroke-base, #333)',
  ...
  return (
    ...
    >
      ...
      <span style={{
        ...
        bottom: '2px',
        fontSize: '9px',
        color: isSelected ? 'rgba(255, 255, 255, 0.8)' : 'var(--glass-text-tertiary, #666)'
      }}>
      ...
      {clip.transition && clip.transition.type !== 'none' && (
        <div style={{
          ...
          width: '12px',
          height: '12px',
          background: 'var(--glass-tone-warning-fg, #F59E0B)',
          borderRadius: '50%',
          fontSize: '8px',
          color: 'white',
          display: 'flex',
